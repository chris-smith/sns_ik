 ...
 */
 ...
 #ifndef SNS_IK_ROBOT_MODEL_IIWA_H_
 #define SNS_IK_ROBOT_MODEL_IIWA_H_
...
/*
* This function returns a KDL chain object that represents the kinematics of an Iiwa Robot arm.
* @param[out] jointNames: names of all non-trivial joints
* @return: kinematic chain between for the full Iiwa.
*/
KDL::Chain getKdlChain(std::vector<std::string>* jointNames);

/*
* This function returns the joint limits for the iiwa robot arm
...
#endif  // SNS_IK_ROBOT_MODEL_IIWA_H_
